...
VDAI (LT) is our lead interlocutor as establishment state; DVI (LV) and
AKI (EE) appear for cross-border matters affecting their residents.
...
Do NOT store complainant personal data here beyond the minimum needed to
identify the case; the DPO holds the DSAR-side records.
